...
export default function UsersPage() {
    ...
    const confirmDeleteUser = async () => {
        ...
        await fetch(
            `https://godrive-5r3o.onrender.com/api/users/${deleteUserId}`,
            {
                method: "DELETE",
                headers: {
    ...
    const updateUser = async () => {
        ...
        await fetch(
            `https://godrive-5r3o.onrender.com/api/users/${editUser.id}`,
            {
                method: "PUT",
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    return (
        <div className="p-6 text-white">
            ...
            <div className="bg-black/40 border border-gray-800 rounded-xl overflow-hidden relative">
                {loading && (
